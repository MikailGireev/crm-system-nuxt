...
<template>
  <div class="text-center mb-2">
    <button
      ...
      <Icon v-if="isOpenForm" name="mdi:arrow-up" size="35" class="fade-in-100 fade-out-0" />
      <Icon v-else name="mdi:plus" size="35" class="fade-in-100 fade-out-0" />
    </button>
  </div>

  <form v-if="isOpenForm" class="form" @submit="onSumbit">
    <UiInput
